  ...
  function initHeroSlider() {
    ...
    const setPlayPauseIcon = (playing) => {
      el.querySelectorAll("[data-video-play-pause]").forEach((btn) => {
        btn.innerHTML = playing ? '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#fff"><rect x="5" y="3" width="4" height="18"/><rect x="15" y="3" width="4" height="18"/></svg>' : '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#fff"><polygon points="5,3 19,12 5,21"/></svg>';
      });
    };
    ...
    splide.on("video:play", (player) => {
      activePlayer = player;
      el.querySelectorAll("[data-video-thumb]").forEach((el2) => {
